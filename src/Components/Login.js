          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <input
                ...
                className="w-full mt-2 px-4 py-3 border-2 border-gray-500 rounded-lg bg-white focus:border-blue-500 outline-none" value={LoginDetails.email}
            ...
            <div className="relative">
              <input
                ...
                className="w-full mt-2 px-4 py-3 border-2  border-gray-500 rounded-lg bg-white focus:border-blue-500 outline-none" value={LoginDetails.password}
                onChange={handlechange}
              />
