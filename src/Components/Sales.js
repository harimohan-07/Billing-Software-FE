...
export default function Sales() {
  ...
  function handleChange(e) {
    ...
    setData({
      ...data,
      [name]: value,
      totalAmount: calculateTotal({ ...data, [name]: value }),
    });
  ...
  function handleEdit(index) {
    setData(salesList[index]);
    setEditIndex(index);
  }

  function handleDelete(index) {
    const updated = salesList.filter((_, i) => i !== index);
    setSalesList(updated);
    if (editIndex === index) {
      setEditIndex(null);
      setData({
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-blue-200 flex justify-center items-start px-4 pt-28 pb-10">
      ...
      <div className="w-full max-w-4xl bg-white/80 p-6 md:p-8 rounded-2xl shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm mt-2">Auto-calculating GST & totals</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className=" space-y-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              {error.customerName && <p className="text-red-500 text-sm">{error.customerName}</p>}
            </div>
                <div>
            ...
            <div>
              ...
              {error.product && <p className="text-red-500 text-sm">{error.product}</p>}
            </div>
            ...
            <div>
              ...
              {error.paymentMode && <p className="text-red-500 text-sm">{error.paymentMode}</p>}
            </div>
          ...
          <div className="px-8 py-4 flex flex-col sm:flex-row gap-3 mt-4 justify-center">
            ...
            <button
              ...
              ${editIndex !== null ? "bg-red-600 hover:bg-red-700": "bg-gray-600 hover:bg-gray-700"}
    `}
            >
        ...
        <div className="mt-12 bg-white/90 rounded-xl shadow border overflow-hidden">
          <h2 className="text-xl font-bold p-4 border-b bg-gray-100">Saved Sales</h2>
